namespace Amazon.Powershell.CloudFront
{
    ...
    public class DeleteDistributionCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.DeleteDistributionRequest request = new Amazon.CloudFront.Model.DeleteDistributionRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.DeleteDistributionResponse response = client.DeleteDistribution(request);
        }
    }
}
