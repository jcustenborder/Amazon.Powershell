namespace Amazon.Powershell.CloudFront
{
    ...
    public class CreateStreamingDistributionCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.CreateStreamingDistributionRequest request = new Amazon.CloudFront.Model.CreateStreamingDistributionRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.CreateStreamingDistributionResponse response = client.CreateStreamingDistribution(request);
        }
    }
}
