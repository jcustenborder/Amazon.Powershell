namespace Amazon.Powershell.CloudFront
{
    ...
    public class GetStreamingDistributionInfoCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.GetStreamingDistributionInfoRequest request = new Amazon.CloudFront.Model.GetStreamingDistributionInfoRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.GetStreamingDistributionInfoResponse response = client.GetStreamingDistributionInfo(request);
        }
    }
}
