namespace Amazon.Powershell.CloudFront
{
    ...
    public class CreateOriginAccessIdentityCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.CreateOriginAccessIdentityRequest request = new Amazon.CloudFront.Model.CreateOriginAccessIdentityRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.CreateOriginAccessIdentityResponse response = client.CreateOriginAccessIdentity(request);
        }
    }
}
