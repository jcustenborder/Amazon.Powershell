namespace Amazon.Powershell.CloudFront
{
    ...
    public class SetOriginAccessIdentityConfigCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.SetOriginAccessIdentityConfigRequest request = new Amazon.CloudFront.Model.SetOriginAccessIdentityConfigRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.SetOriginAccessIdentityConfigResponse response = client.SetOriginAccessIdentityConfig(request);
        }
    }
}
