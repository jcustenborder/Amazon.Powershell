namespace Amazon.Powershell.CloudFront
{
    ...
    public class GetDistributionConfigCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.GetDistributionConfigRequest request = new Amazon.CloudFront.Model.GetDistributionConfigRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.GetDistributionConfigResponse response = client.GetDistributionConfig(request);
        }
    }
}
