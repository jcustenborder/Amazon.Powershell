namespace Amazon.Powershell.CloudFront
{
    ...
    public class ListOriginAccessIdentitiesCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.ListOriginAccessIdentitiesRequest request = new Amazon.CloudFront.Model.ListOriginAccessIdentitiesRequest();
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            request.Id = this._Id;
            request.ETag = this._ETag;
            Amazon.CloudFront.Model.ListOriginAccessIdentitiesResponse response = client.ListOriginAccessIdentities(request);
        }
    }
}
