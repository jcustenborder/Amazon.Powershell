namespace Amazon.Powershell.CloudFront
{
    ...
    public class GetDistributionInfoCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.GetDistributionInfoRequest request = new Amazon.CloudFront.Model.GetDistributionInfoRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.GetDistributionInfoResponse response = client.GetDistributionInfo(request);
        }
    }
}
