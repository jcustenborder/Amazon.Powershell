namespace Amazon.Powershell.CloudFront
{
    ...
    public class GetOriginAccessIdentityInfoCmdlet : CloudFrontCmdLet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            Amazon.CloudFront.Model.GetOriginAccessIdentityInfoRequest request = new Amazon.CloudFront.Model.GetOriginAccessIdentityInfoRequest();
            request.Id = this._Id;
            request.ETag = this._ETag;
            request.Marker = this._Marker;
            request.MaxItems = this._MaxItems;
            Amazon.CloudFront.Model.GetOriginAccessIdentityInfoResponse response = client.GetOriginAccessIdentityInfo(request);
        }
    }
}
